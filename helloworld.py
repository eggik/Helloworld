			...
			try:
				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						if cmd == "logout":
							client.sendReplyMessage(msg.id, to, "Berhasil mematikan selfbot")
							sys.exit("[ INFO ] BOT SHUTDOWN")
							return
						elif cmd == "restart":
							client.sendReplyMessage(msg.id, to, "Berhasil mereset bot")
							restartBot()
						elif cmd == "speed":
							start = time.time()
							...
							client.sendReplyMessage(msg.id, to, "Selfbot telah aktif selama {}".format(str(runtime)))
							...
							if " " in key:
								...
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah set key command menjadi : 「{}」".format(str(key).lower()))
						elif cmd == "help":
							...
							if settings["autoAdd"] == True:
								client.sendReplyMessage(msg.id, to, "Auto add telah aktif")
							else:
								settings["autoAdd"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan auto add")
						elif cmd == "autoadd off":
							if settings["autoAdd"] == False:
								client.sendReplyMessage(msg.id, to, "Auto add telah nonaktif")
							else:
								settings["autoAdd"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan auto add")
						elif cmd == "autojoin on":
							if settings["autoJoin"] == True:
								client.sendReplyMessage(msg.id, to, "Auto join telah aktif")
							else:
								settings["autoJoin"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan auto join")
						elif cmd == "autojoin off":
							if settings["autoJoin"] == False:
								client.sendReplyMessage(msg.id, to, "Auto join telah nonaktif")
							else:
								settings["autoJoin"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan auto join")
						elif cmd == "autojointicket on":
							if settings["autoJoinTicket"] == True:
								client.sendReplyMessage(msg.id, to, "Auto join ticket telah aktif")
							else:
								settings["autoJoinTicket"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan auto join ticket")
						elif cmd == "autojointicket off":
							if settings["autoJoinTicket"] == False:
								client.sendReplyMessage(msg.id, to, "Auto join ticket telah nonaktif")
							else:
								settings["autoJoinTicket"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan auto join ticket")
						elif cmd == "autoread on":
							if settings["autoRead"] == True:
								client.sendReplyMessage(msg.id, to, "Auto read telah aktif")
							else:
								settings["autoRead"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan auto read")
						elif cmd == "autoread off":
							if settings["autoRead"] == False:
								client.sendReplyMessage(msg.id, to, "Auto read telah nonaktif")
							else:
								settings["autoRead"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan auto read")
						elif cmd == "autorespon on":
							if settings["autoRespon"] == True:
								client.sendReplyMessage(msg.id, to, "Auto respon telah aktif")
							else:
								settings["autoRespon"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan auto respon")
						elif cmd == "autorespon off":
							if settings["autoRespon"] == False:
								client.sendReplyMessage(msg.id, to, "Auto respon telah nonaktif")
							else:
								settings["autoRespon"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan auto respon")
						elif cmd == "checkcontact on":
							if settings["checkContact"] == True:
								client.sendReplyMessage(msg.id, to, "Check details contact telah aktif")
							else:
								settings["checkContact"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan check details contact")
						elif cmd == "checkcontact off":
							if settings["checkContact"] == False:
								client.sendReplyMessage(msg.id, to, "Check details contact telah nonaktif")
							else:
								settings["checkContact"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan Check details contact")
						elif cmd == "checkpost on":
							if settings["checkPost"] == True:
								client.sendReplyMessage(msg.id, to, "Check details post telah aktif")
							else:
								settings["checkPost"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan check details post")
						elif cmd == "checkpost off":
							if settings["checkPost"] == False:
								client.sendReplyMessage(msg.id, to, "Check details post telah nonaktif")
							else:
								settings["checkPost"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan check details post")
						elif cmd == "checksticker on":
							if settings["checkSticker"] == True:
								client.sendReplyMessage(msg.id, to, "Check details sticker telah aktif")
							else:
								settings["checkSticker"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan check details sticker")
						elif cmd == "checksticker off":
							if settings["checkSticker"] == False:
								client.sendReplyMessage(msg.id, to, "Check details sticker telah nonaktif")
							else:
								settings["checkSticker"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan check details sticker")
							...
							try:
								...
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah pesan auto add menjadi : 「{}」".format(txt))
							except:
								client.sendReplyMessage(msg.id, to, "Gagal mengubah pesan auto add")
						elif cmd.startswith("setautoresponmessage: "):
							sep = text.split(" ")
							txt = text.replace(sep[0] + " ","")
							try:
								settings["autoResponMessage"] = txt
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah pesan auto respon menjadi : 「{}」".format(txt))
							except:
								client.sendReplyMessage(msg.id, to, "Gagal mengubah pesan auto respon")
						elif cmd.startswith("setautojoinmessage: "):
							sep = text.split(" ")
							txt = text.replace(sep[0] + " ","")
							try:
								settings["autoJoinMessage"] = txt
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah pesan auto join menjadi : 「{}」".format(txt))
							except:
								client.sendReplyMessage(msg.id, to, "Gagal mengubah pesan auto join")
							...
							if len(name) <= 20:
								...
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah nama menjadi : {}".format(name))
							...
							if len(bio) <= 500:
								...
								client.updateProfile(profile)
								client.sendReplyMessage(msg.id, to, "Berhasil mengubah bio menjadi : {}".format(bio))
						elif cmd == "me":
							...
							if 'MENTION' in msg.contentMetadata.keys()!= None:
								...
								for ls in lists:
									...
									client.sendContact(to, sender)
									client.sendReplyMessage(msg.id, to, "Berhasil clone profile")
							...
							try:
								...
								client.sendReplyMessage(msg.id, to, "Berhasil restore profile")
								client.sendContact(to, sender)
								client.deleteFile(clientPictureStatus)
							except Exception as error:
								logError(error)
								client.sendReplyMessage(msg.id, to, "Gagal restore profile")
							...
							try:
								...
								client.sendReplyMessage(msg.id, to, "Berhasil backup profile")
							except Exception as error:
								logError(error)
								client.sendReplyMessage(msg.id, to, "Gagal backup profile")
						elif cmd == "friendlist":
							...
							client.sendReplyMessage(msg.id, to, "Berhasil broadcast ke {} teman".format(str(len(contacts))))
							...
							if msg.toType == 2:
								...
								if len(groupname) <= 20:
									...
									client.sendReplyMessage(msg.id, to, "Berhasil mengubah nama group menjadi : {}".format(groupname))
						elif cmd == "openqr":
							if msg.toType == 2:
								group = client.getGroup(to)
								...
								client.sendReplyMessage(msg.id, to, "Berhasil membuka QR Group\n\nGroupURL : line://ti/g/{}".format(groupUrl))
						elif cmd == "closeqr":
							if msg.toType == 2:
								group = client.getGroup(to)
								group.preventedJoinByTicket = True
								client.updateGroup(group)
								client.sendReplyMessage(msg.id, to, "Berhasil menutup QR Group")
							...
							if msg.toType == 2:
								group = client.getGroup(to)
								client.sendReplyMessage(msg.id, to, "Nama Group : {}".format(group.name))
						elif cmd == "groupid":
							if msg.toType == 2:
								group = client.getGroup(to)
								client.sendReplyMessage(msg.id, to, "Group ID : {}".format(group.id))
						elif cmd == "grouplist":
							...
							client.sendReplyMessage(msg.id, to, "Berhasil broadcast ke {} group".format(str(len(groups))))
							...
							if to in read['readPoint']:
								...
								read['readMember'][to] = []
								client.sendReplyMessage(msg.id, to, "Lurking telah diaktifkan")
							else:
								try:
									del read['readPoint'][to]
									del read['readMember'][to]
							...
							if to not in read['readPoint']:
								client.sendReplyMessage(msg.id, to,"Lurking telah dinonaktifkan")
							else:
								try:
									del read['readPoint'][to]
									del read['readMember'][to]
									...
									pass
								client.sendReplyMessage(msg.id, to, "Delete reading point : \n{}".format(readTime))
						elif cmd == "lurking":
							if to in read['readPoint']:
								if read["readMember"][to] == []:
									return client.sendReplyMessage(msg.id, to, "Tidak Ada Sider")
								else:
									no = 0
									result = "╔══[ Reader ]"
							...
							client.sendReplyMessage(msg.id, to, "Silahkan kirim gambarnya")
							...
							if settings["mimic"]["status"] == True:
								client.sendReplyMessage(msg.id, to, "Reply message telah aktif")
							else:
								settings["mimic"]["status"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan reply message")
						elif cmd == "mimic off":
							if settings["mimic"]["status"] == False:
								client.sendReplyMessage(msg.id, to, "Reply message telah nonaktif")
							else:
								settings["mimic"]["status"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan reply message")
						elif cmd == "mimiclist":
							if settings["mimic"]["target"] == {}:
								client.sendReplyMessage(msg.id, to, "Tidak Ada Target")
							else:
								no = 0
								result = "╔══[ Mimic List ]"
								target = []
								...
								for ls in lists:
									try:
										if ls in settings["mimic"]["target"]:
											client.sendReplyMessage(msg.id, to, "Target sudah ada dalam list")
										else:
											settings["mimic"]["target"][ls] = True
											client.sendReplyMessage(msg.id, to, "Berhasil menambahkan target")
									except:
										client.sendReplyMessage(msg.id, to, "Gagal menambahkan target")
								...
								for ls in lists:
									try:
										if ls not in settings["mimic"]["target"]:
											client.sendReplyMessage(msg.id, to, "Target sudah tida didalam list")
										else:
											del settings["mimic"]["target"][ls]
											client.sendReplyMessage(msg.id, to, "Berhasil menghapus target")
									except:
										client.sendReplyMessage(msg.id, to, "Gagal menghapus target")
							...
							if lang not in language["gtts"]:
								return client.sendReplyMessage(msg.id, to, "Bahasa {} tidak ditemukan".format(lang))
							...
							client.sendReplyMessage(msg.id, to, result.text)
						if text.lower() == "mykey":
							client.sendReplyMessage(msg.id, to, "Keycommand yang diset saat ini : 「{}」".format(str(settings["keyCommand"])))
						elif text.lower() == "setkey on":
							if settings["setKey"] == True:
								client.sendReplyMessage(msg.id, to, "Setkey telah aktif")
							else:
								settings["setKey"] = True
								client.sendReplyMessage(msg.id, to, "Berhasil mengaktifkan setkey")
						elif text.lower() == "setkey off":
							if settings["setKey"] == False:
								client.sendReplyMessage(msg.id, to, "Setkey telah nonaktif")
							else:
								settings["setKey"] = False
								client.sendReplyMessage(msg.id, to, "Berhasil menonaktifkan setkey")
